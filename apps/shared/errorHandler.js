...
class ErrorHandler {
  ...
  setupGlobalHandlers() {
    ...
    window.addEventListener('unhandledrejection', (event) => {
      ...
      this.showUserMessage('An unexpected error occurred. Please refresh the page.', 'error');
    });
  ...
  getUserMessage(error) {
    ...
    const errorMap = {
      ...
      'no active subscription': 'You need an active subscription to access this feature.',
