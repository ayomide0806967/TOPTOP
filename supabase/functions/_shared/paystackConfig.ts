const DEFAULT_PUBLIC_KEY =
  'pk_test_943cfcdf1016a38545eeeefed3a0735df0e2caf4';
const DEFAULT_SECRET_KEY =
  'sk_test_951fc9e51b016751378bf3a78bce024f32676b5c';
...
const DEMO_MODE_ALIASES = new Set(['', 'demo', 'test', 'sandbox', 'development']);
